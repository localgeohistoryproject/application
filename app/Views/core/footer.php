			...
			<footer class="headerfooter">
			    <div id="footertext" class="bodytext">
			        ...
			        <?= lang('Template.code') ?> <?= lang('Template.license') ?> <a rel="license" href="https://creativecommons.org/licenses/by-sa/4.0/deed.<?= \Config\Services::request()->getLocale() ?>">CC BY-SA 4.0</a> |
